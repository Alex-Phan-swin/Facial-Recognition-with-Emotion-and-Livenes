...
cos_fpr, cos_tpr, cosine_auc = evaluate(pairs, "cosine")
euc_fpr, euc_tpr, euclid_auc = evaluate(pairs, "euclidean")

print("\n========== RESULTS ==========")
print(f"Cosine AUC:    {cosine_auc:.4f}")
print(f"Euclidean AUC: {euclid_auc:.4f}")
...
plt.plot(
    euc_fpr,
    euc_tpr,
    label=f"Euclidean Distance (AUC = {euclid_auc:.4f})"
)
